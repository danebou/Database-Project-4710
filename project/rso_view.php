    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo $rso_name?></li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> <?php echo $rso_name?>
                </div>
                <div class="card-block">
                    <p class="small-text"> <?php echo $rso_desc?> </p>
                    <p class="small-text"> Students: <?php echo $rso_student_count?>  </p>
                    <p class="small-text"> <?php echo $rso_event_list ?> </p>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
