    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Browse RSO's</li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i>  Search and Request to join an RSO 
                </div>
                <div class="card-block">
                    <p class="small-text"> These are RSO's that can be searched for </p>
                    <p class="small-text"> <!-- Search form (Submit to backend in php/search_join_rso.php"-->
						<form method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
						RSO name: <input type="text" name="name">
						<input type="submit" name="submit" value="Submit"> 
						</form>
                    </p>
                    <p class="small-text"> Now check out these spicy RSOs to join: </p>
                    <p class="small-text"> <?php echo $rso_list?> </p>
                    <p class="small-text"> <?php echo $status?> </p>
                </div>
