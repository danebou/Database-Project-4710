    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Nearby Events</li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Nearby Events
                </div>
                <div class="card-block">
                    <p class="small-text"> Now check out these event that doctors don't want you to know about!: </p>
                    <p class="small-text"> <?php echo $nearby_events?> </p>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
