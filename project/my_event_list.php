        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> My Events
                </div>
                <div class="card-block">
                    <p class="small-text"> These are your events you created </p>
                    <p class="small-text"> Trainers hate these events you can go to: </p>
                    <p class="small-text"> <?php echo $event_list?> </p>
                    <p class="small-text"> <a href="event_edit.php">Create New</a> </p>
