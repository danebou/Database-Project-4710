        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-block">
                    ...
                    <p class="small-text"> Number of Students: <input type="text" name="studCount" value="<?php echo $studCount_value?>"> </p>
                    <p class="small-text"> Email Domain (ex: knights.ucf.edu): <input type="text" name="domain" value="<?php echo $domain_value?>"> </p>
