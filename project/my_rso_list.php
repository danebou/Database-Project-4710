    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">My RSOs</li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-address-book"></i> My RSOs
                </div>
                <div class="card-block">
                    <p class="small-text"> These are your rsos you are admin of </p>
					<p class="small-text"> Now check out these radical RSOS you are apart of: </p>
    				<p class="small-text"><?php echo $rso_list?> </p>
					<p class="small-text"><a href="rso_edit.php">Create New</a> </p>
