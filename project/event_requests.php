    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Non-RSO Event Requests</li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Non-RSO Event Requests
                </div>
                <div class="card-block">
                    <p class="small-text"> These are non-RSO events requiring approval </p>
                    <p class="small-text"> Now check out these dank non-rso event requests you can approve/remove: </p>
                    <p class="small-text"> <?php echo $event_requests?> </p>
                </div>
            </div>            
        </div>
        <!-- /.container-fluid -->
