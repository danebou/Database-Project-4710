    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo $uni_name?></li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-institution"></i> <?php echo $uni_name?>
                </div>
                <div class="card-block">
                    <p class="small-text">  <?php echo $uni_desc?>  </p>
                    <p class="small-text"> Students: <?php echo $uni_student_count?> </p>
                    <p class="small-text"> <?php echo $uni_pics ?> </p>
                    <p class="small-text"> <?php echo $uni_event_list?> </p>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
